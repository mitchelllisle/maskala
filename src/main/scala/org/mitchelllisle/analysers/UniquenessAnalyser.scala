...
/** A class to analyze the uniqueness of values within a DataFrame using Spark. This class provides methods to read data
  ...
  *
  * Uniqueness is a proxy for re-identifiability. Knowing how re-identifiable the individuals in a table are is an
  * important privacy engineering concept. This class helps you evaluate some metrics for the risk using the uniqueness
  * of the data as an indicator.
  */
object UniquenessAnalyser {
  ...
  /** Calculates the uniqueness of each value in the source table.
    *
    * @param data
    *   The DataFrame created from createSourceTable method.
    * @return
    *   A DataFrame with each value and its corresponding count of unique user IDs.
    */
  ...
  /** Counts the total number of unique values in the uniqueness data.
    ...
    *   The DataFrame returned from the calculateUniquenessData method.
    * @return
    *   The total number of unique values as a Long.
    */
  ...
  /** Calculates the distribution of values across different levels of uniqueness.
    *
    * @param uniquenessData
    *   The DataFrame containing the uniqueness data.
    * @param numValues
    *   The total number of unique values, obtained from countNumValues.
    * @return
    *   A DataFrame with the distribution of values for each level of uniqueness.
    */
  ...
  /** Calculates the cumulative distribution of uniqueness.
    *
    * @param uniquenessDistribution
    *   The DataFrame containing the uniqueness distribution.
    * @return
    *   A DataFrame with cumulative counts and ratios of the uniqueness distribution.
    */
  ...
  /** Orchestrates the process of calculating the uniqueness distribution in a dataset.
    ...
    *   Columns to be grouped by in the source table.
    * @param userIdColumn
